...
<body>
    <div class="container">
        <div class="header">
            <div class="logoimage">
                <img id="imagemail" src="https://prosevo.com/assets/ProSEvo-modified.png" alt="" width="100" style="margin-top: 10px;">
            </div>
        ...
        <div class="content">
            <div class="mainDiv">
                <div class="subMaindiv">
                    ...
                    <img id="imagemail" src="${path.join(__dirname,'/images/imagemail.png')}" alt="" width="300">
